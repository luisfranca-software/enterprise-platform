...
ChatGPT and OpenCode represent architectural and implementation roles within this engineering workflow. This role-based framing makes the methodology reusable even if different AI tools are adopted in the future. Architectural decisions undergo AI review, implementation is generated by the AI developer, every change is approved by a human developer, and only then committed to Git and published to GitHub.
...
|-------|---------------|
| Human | Product vision, requirements and final approval |
| Architecture Review (ChatGPT) | Architecture decisions, engineering review and technical guidance |
| Implementation (OpenCode) | Code generation and project file modifications |
| Human Technical Review | Validation, testing and approval before versioning |
| Git | Version control |
| GitHub | Repository hosting, collaboration and CI/CD |
